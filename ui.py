...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.label_2.setGeometry(QtCore.QRect(110, 60, 171, 151))
        self.label_2.setText("")
        self.label_2.setPixmap(QtGui.QPixmap("ui_img/reverse.png"))
        self.label_2.setScaledContents(True)
        self.label_2.setObjectName("label_2")
        self.input_amount = QtWidgets.QLineEdit(self.centralwidget)
        self.input_amount.setGeometry(QtCore.QRect(40, 230, 321, 60))
        font = QtGui.QFont()
        font.setFamily("Tahoma")
...
"color: white;")
        ...
        self.input_currency.setGeometry(QtCore.QRect(40, 310, 331, 60))
        font = QtGui.QFont()
        font.setFamily("Tahoma")
        font.setPointSize(14)
        font.setBold(True)
...
"color: white;")
        ...
        self.output_currency.setGeometry(QtCore.QRect(40, 390, 331, 60))
        font = QtGui.QFont()
        font.setFamily("Tahoma")
        font.setPointSize(14)
        font.setBold(True)
...
"color: white;")
        ...
        self.output_amount.setGeometry(QtCore.QRect(40, 470, 331, 60))
        font = QtGui.QFont()
        font.setFamily("Tahoma")
        font.setPointSize(14)
        font.setBold(True)
...
"color: white;")
        ...
        self.pushButton.setGeometry(QtCore.QRect(40, 550, 331, 60))
        font = QtGui.QFont()
        font.setFamily("Tahoma")
        font.setPointSize(14)
        font.setBold(True)
...
"}")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.pushButton.setText(_translate("MainWindow", "КОНВЕРТИТУЙ"))
